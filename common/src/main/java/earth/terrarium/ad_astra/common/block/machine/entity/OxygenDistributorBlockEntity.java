    ...
    public void tick() {
        ...
        if (!this.level.isClientSide) {
            ...
            if (this.getEnergyStorage().internalExtract(this.getEnergyPerTick(), true) > 0) {
                ...
                if (this.getEnergyStorage().internalExtract(this.getEnergyPerTick(), true) >= this.getEnergyPerTick() && FluidUtils.convertFluid(this.getFluidContainer(), recipes, FluidHooks.buckets(1f) / 10)) {
